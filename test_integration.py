...
def test_word_penalty():
    long_results = recommended_search("12345", beam_size=5, vocab_limit=5, word_penalty=-2, blank_vocab=2)
    short_results = recommended_search("12345", beam_size=5, vocab_limit=5, word_penalty=2, blank_vocab=2)
...
def test_char_penalty():
    long_results = recommended_search("89762", beam_size=5, vocab_limit=10, char_penalty=-4, blank_vocab=4)
    short_results = recommended_search("89762", beam_size=5, vocab_limit=10, char_penalty=4, blank_vocab=4)
